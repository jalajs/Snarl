...
public class LocalUserTest {
  ...
  public void testUserUpdate() {
    ...
    adversaryTile.setOccupier(new Adversary(AdversaryType.GHOST,"Jimbo"));
  ...
  public void testVisibleTileRepresentation() {
    ...
    Tile adversaryTile = new Tile(false);
    playerTile.setOccupier(new Player("Bob"));
    adversaryTile.setOccupier(new Adversary(AdversaryType.ZOMBIE,"Jimbo"));
  ...
  public void testBuildAction(){
    ...
    Actor adversary = new Adversary(AdversaryType.ZOMBIE,"Jimbo");
