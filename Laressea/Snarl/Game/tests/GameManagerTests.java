...
public class GameManagerTests {
  ...
  public void testAddAdversaries() {
    ...
    gameManager.addAdversary(AdversaryType.ZOMBIE, "Jo");
    assertEquals(gameManager.getAdversaries().size(), 1);
    assertEquals(AdversaryType.ZOMBIE, gameManager.getAdversaries().get(0).getType());
  }
  ...
  public void testExecuteAction() {
    ...
    manager.addAdversary(AdversaryType.ZOMBIE, "Rolph");
    manager.addAdversary(AdversaryType.ZOMBIE, "Mr Bean");
    manager.setTurn(0);
    manager.setGs(gs);
    ...
    Adversary adversary1 = new Adversary(AdversaryType.ZOMBIE, "Carl");
    Adversary adversary2 = new Adversary(AdversaryType.ZOMBIE, "Robert");
