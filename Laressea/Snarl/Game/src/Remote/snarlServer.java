...
public class snarlServer {
  ...
  private static boolean multiGameValue = false;
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      multiGameValue = cmd.hasOption("multi");
    ...
    Server server = new Server(addressValue, portValue, gameManager, delayValue, observerValue, clientValue, multiGameValue);
    server.run();
  }
    ...
    private static Options buildCommandOptions() {
      ...
      Option multiInput = new Option("m", "multi", false, "multi game server");
      multiInput.setRequired(false);
      options.addOption(multiInput);
